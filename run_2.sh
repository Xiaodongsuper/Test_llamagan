...
conda activate base # Modify the conda environment path
...
bash scripts/autoregressive/extract_codes_c2i.sh --vq-ckpt ./pretrained_models/vae/vq_ds16_c2i.pt --data-path ./CUB_200_2011_dataset/train --code-path ${PROJECT_ROOT}/cub200_code_c2i_flip_ten_crop1 --ten-crop --crop-range 1.1 --image-size 384
...
# generate images you can change the  parameters in sample_c2i_class_each_model.sh
