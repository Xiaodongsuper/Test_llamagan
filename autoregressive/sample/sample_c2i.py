...
def main(args):
    ...
    save_image(samples, "sample_{}_{}.png".format(args.gpt_type, args.gpt_ckpt.split('/')[-2]), nrow=4, normalize=True, value_range=(-1, 1))
    print(f"image is saved to sample_{args.gpt_type}_{args.gpt_ckpt}.png")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--temperature", type=float, default=1, help="temperature value to sample with")
