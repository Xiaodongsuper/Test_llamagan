...
class CustomDataset(Dataset):
    def __init__(self, feature_dir, label_dir):
        ...
        self.feature_files = [f"{i}.npy" for i in range(50000)]
        self.label_files = [f"{i}.npy" for i in range(50000)]
...
def build_cifar10_code(args):
    feature_dir = f"{args.code_path}/cifar10{args.image_size}_codes"
    label_dir = f"{args.code_path}/cifar10{args.image_size}_labels"
